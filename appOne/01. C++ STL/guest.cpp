...
float avarage(const my_container& container) {
	float avg = 0.0f;
...
int main(){
	...
	if (!(delete_guest(my_guests, 2)))
		cout << "delete_guest faild" << endl;
	cout << "----------------------------" << endl;
	print_guests(my_guests);

	cout << "\n\n\nThe average age is " << avarage(*my_guests) << endl;   
